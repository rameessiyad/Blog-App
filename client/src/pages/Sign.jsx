    ...
    <div className='min-h-screen mt-20'>
      <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5">
        ...
        <div className="flex-1">
          ...
          <p className='text-sm mt-5'>You can sign in with your email and password or google</p>
        </div>
        {/* right */}
        <div className="flex-1">
          <form className='flex flex-col gap-4' onSubmit={HandleSubmit}>
            ...
            <div className="">
              ...
              <TextInput type='password' placeholder='Password' id='password' name='password' onChange={HandleChange} required />
            </div>
